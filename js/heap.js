...
class Heap {
  ...
  heapify(index) {
    ...
    if (left < this.dataset.length && this.priorityOf(this.dataset[left]) > this.priorityOf(this.dataset[top])) {
      top = left;
    }
    if (right < this.dataset.length && this.priorityOf(this.dataset[right]) > this.priorityOf(this.dataset[top])) {
      top = right;
    }
  ...
  heapifyUp(index) {
    ...
    if (this.priorityOf(this.dataset[index]) > this.priorityOf(this.dataset[parent])) {
